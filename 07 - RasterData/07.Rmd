...
Before you start: download and unzip the ERA5 data from moodle (2 parts). You can find a directory there with all data we will need. Additionally, you need to install the `ncdf4` package.
