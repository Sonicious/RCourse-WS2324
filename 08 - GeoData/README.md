...
```
    ...
    ## <SpatRaster> resampled to 501000 cells for plotting
...
- The file `trending.R` shows how to calculate the trends on a global
  ...
  the full scale. Save the result as a netCDF. Be aware that the trend
  calculation might need some computational power.
